...
export default function Baby() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-r from-pink-200 via-red-300 to-pink-400">
      {!isAuthenticated ? (
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
          <h1 className="text-2xl font-bold text-gray-800 mb-4">Sweet Notes</h1>
